...
BEGIN_MESSAGE_MAP(CLoaderApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CLoaderApp::OnAppAbout)
...
CLoaderApp::CLoaderApp() noexcept
{
...
BOOL CLoaderApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CLoaderDoc),
		RUNTIME_CLASS(CMainFrame),       // main SDI frame window
		RUNTIME_CLASS(CLoaderView));
	if (!pDocTemplate)
		return FALSE;
